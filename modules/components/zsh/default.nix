      ...
      home-manager.users = lib.genAttrs customization.shells.zsh.lite.users (username: {
        ...
        programs.zsh = {
          ...
          plugins = [
            ...
            oh-my-zsh-plugins [
              "git" "adb" "battery" "colorize" "cp"
              "emoji" "fancy-ctrl-z"
              "fd" "git-flow" "github" "gitignore" "gnu-utils"
              "golang" "history" "httpie" "jsontools" "jump"
              "last-working-dir" "lol" "man" "mosh" "nmap" "node"
              "pep8" "pip" "pj" "ripgrep" "rsync" "shrink-path" "sudo"
              "themes" "transfer" "yarn" "z"
            ]
          );
        };
      });
